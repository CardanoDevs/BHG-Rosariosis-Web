...
?>
	...
	<?php endif; ?>
	<input type="submit" name="restore" value="." style="border: none;background-color: none;display: none">
	...
	<div class="about-rosariosis toggle-me">
		...
		<p class="center size-1">
			...
			<br />&copy; 2012-2019 <a href="https://www.rosariosis.org" noreferrer>RosarioSIS</a>
		</p>
	</div>
