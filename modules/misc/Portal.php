...
DrawHeader( '<span id="salute">' );
/*</span><span id="mints">00</span>:*/
...
function timecounter() {
 ...
 /* if (n == 59) {
  	var a=document.getElementById("mints").val
  	//alert(a);
  	document.getElementById("mints").innerHTML=document.getElementById("mints").value+1;
  }*/
}
</script> -->
<script>
