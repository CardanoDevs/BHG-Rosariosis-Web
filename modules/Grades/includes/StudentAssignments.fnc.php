...
function IsPaceEnabledForCoursePeriodId($course_period_id)
{


    $query = "select is_pace_enabled from course_periods where course_period_id = '$course_period_id'";

    $result = DBGet($query);

    if ($result != null) {
        return $result[1]['IS_PACE_ENABLED'] == 't';
    }
