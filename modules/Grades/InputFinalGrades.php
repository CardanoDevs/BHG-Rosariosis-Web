...
echo '<form action="Modules.php?modname=' . $_REQUEST['modname'] .
    ...
    '&mp=' . $_REQUEST['mp'] . '" method="POST" id="exec">';
...
if ( ! isset( $_REQUEST['_ROSARIO_PDF'] ) )
{
    ...
    if ( AllowEdit() )
    {
        $gb_header .= '<a href="Modules.php?modname=' . $_REQUEST['modname'] . '&include_inactive=' . $_REQUEST['include_inactive'] . '&modfunc=gradebook&mp=' . $_REQUEST['mp'] . '">' . _( '' ) . '</a>';
        ...
        $gb_header .= ' | ';
        $gb_header .= '<a href="Modules.php?modname=' . $_REQUEST['modname'] . '&include_inactive=' . $_REQUEST['include_inactive'] . '&modfunc=clearall&tab_id=' . $_REQUEST['tab_id'] . '&mp=' . $_REQUEST['mp'] . '">' . _( '' ) . '</a>';
    }
...
if(isset($_REQUEST['exec'])){
    echo '<script> document.getElementById("exec").submit();  </script>';
}
/**
